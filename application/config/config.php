...
|
*/
$config['base_url'] = 'http://localhost/Codeigniter3/Rey_shop/';
...
$config['log_threshold'] = 3; // Atau lebih tinggi untuk lebih banyak detail (1 untuk error saja, 2 untuk debug, dll.)
