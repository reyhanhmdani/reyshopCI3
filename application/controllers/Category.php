...
class Category extends MY_Controller
{
	...
	public function search($page = null): void
	{
		...
		$data['title']      = 'Admin: Category';
		$data['content']    = $this->category->like('title', $keyword)->orLike('slug', $keyword)->paginate($page)->get();
		$data['total_rows'] = $this->category->like('title', $keyword)->orLike('slug', $keyword)->count();
		$data['pagination'] = $this->category->makePagination(
	...
	public function unique_slug(): bool
	{
