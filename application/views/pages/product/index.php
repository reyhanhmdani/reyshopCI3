		...
		<div class="col-md-10 mx-auto">
			<div class="card mb-3">
				<div class="card-header">
					<span>Product</span>
					<a href="<?= base_url('product/create') ?>" class="btn btn-sm btn-secondary">Add</a>
						...
						foreach ($content as $row): $no++; ?>
							<tr>
								...
								<td>
									<p>
										<img
											src="<?= $row->image ? base_url("images/product/$row->image") :
												base_url("images/product/default.webp") ?>"
											alt="" height="50">
										<?= $row->product_title ?>
									</p>
								</td>
								<td>
									<span class="badge badge-primary"><i
											class="fas fa-tags"></i> <?= $row->category_title ?></span>
								</td>
